...
variable "jira_conf" {
  ...
  default = {
    ...
    src_jira_home              = "jira_home"
    src_jira_home_node1        = "jira_home_node1"
    src_jira_home_node2        = "jira_home_node2"
    src_jira_home_node3        = "jira_home_node3"
    src_shared_home            = "jira_shared_home"
