...
//  alarm_name          = "${local.common_name}_Jira_EC2_Instance_Free_Space_C_Drive--critical"
...
//  statistic           = "Average"
//  threshold           = 5
//  alarm_description   = "C: Drive Free Space is less than 5% on Jira EC2 Instance."
//  alarm_actions       = [local.sns_alarm_notification_arn]
//  ok_actions          = [local.sns_alarm_notification_arn]
//
//  dimensions = {
...
//  alarm_name          = "${local.common_name}_Jira_EC2_Instance_Free_Space_C_Drive--warning"
//  comparison_operator = "LessThanThreshold"
//  evaluation_periods  = 1
//  metric_name         = "LogicalDisk % Free Space"
//  namespace           = "CWAgent"
...
//  statistic           = "Average"
//  threshold           = 25
//  alarm_description   = "C: Drive Free Space is less than 25% on Jira EC2 Instance."
//  alarm_actions       = [local.sns_alarm_notification_arn]
//  ok_actions          = [local.sns_alarm_notification_arn]
//
//  dimensions = {
